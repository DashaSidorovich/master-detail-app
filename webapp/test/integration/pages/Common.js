sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("zjblessons/masterDetailAppSidorovich/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("zjblessons.masterDetailAppSidorovich.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["zjblessons/masterDetailAppSidorovich/localService/mockserver"], function (mockserver) {
